...
public class ParagraphTypeImpl implements mila.generated.ParagraphType,
	...
	public class Unmarshaller extends
					...
					if (("id" == ___local) && ("" == ___uri)) {
						_getSentence()
								.add(spawnChildFromEnterAttribute(
										(mila.generated.impl.SentenceTypeImpl.class),
		...
		public java.lang.Object owner() {
			return mila.generated.impl.ParagraphTypeImpl.this;
		}

	}

	protected com.sun.xml.bind.util.ListImpl _Sentence;
	...
	private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
		return (mila.generated.ParagraphType.class);
	}

	protected com.sun.xml.bind.util.ListImpl _getSentence() {
		if (_Sentence == null) {
			_Sentence = new com.sun.xml.bind.util.ListImpl(
		...
		if (schemaFragment == null) {
			schemaFragment = com.sun.xml.bind.validator.SchemaDeserializer
					.deserialize(("\u00ac\u00ed\u0000\u0005sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001dcom.su"
							...
							+ "\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000\u0016generated.SentenceTypet\u0000+http://java.sun.com/ja"
							...
							+ "sentencet\u0000\u0000sq\u0000~\u0000\u0015ppsq\u0000~\u0000&ppsr\u0000\"com.sun.msv.datatype.xsd.Toke"
							+ "nType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000"
							+ "\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000+q\u0000~\u00000t\u0000\u0005tokenq\u0000~\u00004\u0001q\u0000~\u00006sq\u0000~\u00007q\u0000"
							+ "~\u0000Dq\u0000~\u00000sq\u0000~\u0000\u001ft\u0000\u0002idq\u0000~\u0000>sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000@sq\u0000~\u0000\u001ft\u0000\tta"
							+ "kenFromq\u0000~\u0000>q\u0000~\u0000\u001esr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
							...
							+ "ammar/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\u0006q\u0000~\u0000\u0012q\u0000~\u0000$q\u0000~\u0000\u0005q\u0000~\u0000\u000eq\u0000~\u0000\u0011q"
							+ "\u0000~\u0000Hq\u0000~\u0000\tx"));
		}
	...
	public mila.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
			mila.generated.impl.runtime.UnmarshallingContext context) {
		return new mila.generated.impl.ParagraphTypeImpl.Unmarshaller(context);
	}
	...
	@Override
	public java.util.List getSentence() {
		return _getSentence();
	}
	...
	public void serializeAttributes(mila.generated.impl.runtime.XMLSerializer context)
			throws org.xml.sax.SAXException {
		int idx1 = 0;
		final int len1 = ((_Sentence == null) ? 0 : _Sentence.size());
	...
	public void serializeBody(mila.generated.impl.runtime.XMLSerializer context)
		...
		final int len1 = ((_Sentence == null) ? 0 : _Sentence.size());
		while (idx1 != len1) {
			context.startElement("", "sentence");
			int idx_0 = idx1;
			context.childAsURIs(
					((com.sun.xml.bind.JAXBObject) _Sentence.get(idx_0++)),
					"Sentence");
			context.endNamespaceDecls();
			int idx_1 = idx1;
			context.childAsAttributes(
					((com.sun.xml.bind.JAXBObject) _Sentence.get(idx_1++)),
					"Sentence");
			context.endAttributes();
			context.childAsBody(
					((com.sun.xml.bind.JAXBObject) _Sentence.get(idx1++)),
					"Sentence");
			context.endElement();
		}
	}
