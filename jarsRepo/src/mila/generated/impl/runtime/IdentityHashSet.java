...
/**
 * A set of {@link Object}s that uses the == (instead of equals) for the
 * comparison.
 * 
...
final class IdentityHashSet {
	 ...
	 * rehash.
	 * 
	 * It is possible for one thread to call get method while another thread is
	 * performing rehash. Keep this in mind.
	 */
	private void rehash() {
		...
		for (int i = oldCapacity; i-- > 0;)
			if (oldMap[i] != null) {
				int index = (System.identityHashCode(oldMap[i]) & 0x7FFFFFFF)
						% newMap.length;
