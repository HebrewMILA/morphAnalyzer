...
/**
 * This class provides the default implementation of JAXBContext. It also
 * creates the GrammarInfoFacade that unifies all of the grammar info from
 * packages on the contextPath.
 * 
...
public class DefaultJAXBContextImpl extends JAXBContext {
	 ...
	 * generated JAXBContextImpl objects. It is also used by the bootstrapping
	...
	public DefaultJAXBContextImpl(String contextPath, ClassLoader classLoader)
		...
		this(GrammarInfoFacade
				.createGrammarInfoFacade(contextPath, classLoader));
	...
	/**
	 * Create an <CODE>Unmarshaller</CODE> object that can be used to convert
	 ...
	 * 
	 * <p>
	 * getGrammar is normally very expensive, so it's worth synchronizing to
	 * avoid unnecessary invocation.
	 */
	public synchronized com.sun.msv.grammar.Grammar getGrammar()
			throws JAXBException {
		if (grammar == null)
		...
		try {
			...
			if (c == null)
				throw new JAXBException(Messages.format(
						Messages.MISSING_INTERFACE, javaContentInterface));
