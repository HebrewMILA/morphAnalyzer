 ...
 * 
 * <p>
 * This component internally uses a VerifierFilter to validate SAX events that
 * goes through this component. Discovered error information is just passed down
 * to the next component.
 * 
 * <p>
 * This will enable the implementation to validate all sources of SAX events in
 * the RI - XMLReader, DOMScanner
 * 
 * SAX events will go the VerifierFilter and then to the SAXUnmarshaller...
 * 
 */
public class ValidatingUnmarshaller extends ForkContentHandler implements
	...
	public static ValidatingUnmarshaller create(Grammar grammar,
			SAXUnmarshallerHandler _core, Locator locator) {
	...
	@Override
	public void startElement(String nsUri, String local, String qname,
			Attributes atts) throws SAXException {
		// create an attributes set for MSV that doesn't contains
		// xsi:schemaLocation
		xsiLessAtts.clear();
		...
		for (int i = 0; i < len; i++) {
			...
			xsiLessAtts.addAttribute(aUri, aLocal, atts.getQName(i),
