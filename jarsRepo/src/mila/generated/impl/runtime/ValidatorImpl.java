...
public class ValidatorImpl implements Validator {
	/**
	 * We need to know whether an validation error was detected or not. For this
	 * purpose, we set up the validation so that this interceptor will
	 * "intercept" errors before the application receives it.
	 */
	...
	private boolean validate(Object o, boolean validateId)
		...
		try {
			...
			// we need a consistent mechanism to convert SAXException into
			// JAXBException
