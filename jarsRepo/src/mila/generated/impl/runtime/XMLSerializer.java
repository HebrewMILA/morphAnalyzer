 ...
 * 
 * <p>
 * A marshalling of one element consists of two stages. The first stage is for
 * marshalling attributes and collecting namespace declarations. The second
 * stage is for marshalling characters/child elements of that element.
 * 
 * <p>
...
public interface XMLSerializer {
	/**
	 * This method is called when an JAXBObject object is found while the
	 * marshaller is in the "attribute" mode (i.e. marshalling attributes of an
	 * element)
	 * 
	 * @param fieldName
	 *            property name of the parent objeect from which 'o' comes. Used
	 *            as a part of the error message in case anything goes wrong
	 *            with 'o'.
	 */
	...
	/**
	 * This method is called when an JAXBObject object is found while the
	 * marshaller is in the "element" mode (i.e. marshalling a content model of
	 * an element)
	 * 
	 * @param fieldName
	 *            property name of the parent objeect from which 'o' comes. Used
	...
	/**
	 * Switches to the mode to marshal child texts/elements. This method has to
	 * be called after the 2nd pass is completed.
	 */
	...
	/**
	 * Switches to the mode to marshal attribute values. This method has to be
	 * called after the 1st pass is completed.
	 */
	void endNamespaceDecls() throws SAXException;

	/**
	 * Obtains a namespace context object, which is used to declare/obtain
	 * namespace bindings.
	 */
	 ...
	 * 
	 * The serializer may or may not check the consistency of ID/IDREFs and may
	 ...
	 *            The value of the ID.
	 * 
	 * @return Return the value parameter without any modification, so that the
	 *         invocation of this method can be done transparently by a
	 *         transducer.
	 */
	...
	/**
	 * Errors detected by the XMLSerializable should be either thrown as
	 * {@link SAXException} or reported through this method.
	 * 
