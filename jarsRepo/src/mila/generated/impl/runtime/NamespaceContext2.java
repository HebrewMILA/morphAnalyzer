 ...
 * 
 * <p>
 * This interface extends {@link NamespaceContext} and provides an additional
...
public interface NamespaceContext2 extends NamespaceContext {
	 ...
	 * 
	 * <p>
	 * The prefix is automatically assigned by MarshallingContext. If a given
	 * namespace URI is already declared, nothing happens.
	 * 
	 * <p>
	 * It is <b>NOT</b> an error to declare the same namespace URI more than
	 * once.
	 * 
	 * <p>
	 * For marshalling to work correctly, all namespace bindings for an element
	 * must be declared between its startElement method and its endAttributes
	 * event. Calling the same method with the same parameter between the
	 * endAttributes and the endElement returns the same prefix.
	 * 
	 * @param requirePrefix
	 ...
	 * 
	 * @return returns the assigned prefix. If the namespace is bound to the
	 *         default namespace, null is returned.
	 */
	String declareNamespace(String namespaceUri, String preferedPrefix,
