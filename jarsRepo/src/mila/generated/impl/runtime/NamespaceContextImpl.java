 ...
 * 
 * This class also provides several utility methods for XMLSerializer-derived
 * classes.
 * 
...
public class NamespaceContextImpl implements NamespaceContext2 {
	...
	/**
	 * Used during the collecting mode to sort out the namespace URIs we need
	 * for this element.
	 * 
	...
	public String declareNamespace(String namespaceUri, String preferedPrefix,
		...
		if (!inCollectingMode) {
			...
			if (namespaceUri.length() == 0) {
				// the empty namespace URI needs to be bound to the default
				// prefix.
				prefix = "";
			} else {
				...
				if (prefix == null) {
					...
					// prefixMapper decide if it wants to use the suggested
					// prefix.
					// otherwise our best bet is the suggested prefix.
					if (prefixMapper != null)
						prefix = prefixMapper.getPreferredPrefix(namespaceUri,
								preferedPrefix, requirePrefix);
					else
	 ...
	 * 
	 * This method should be called at the end of the endElement method of
	 * derived classes.
	 */
	...
	/**
	 * Reconciles the namespace URI/prefix mapping requests since the last
	 * startElement method invocation and finalizes them.
	 * 
	 * This method must be called after all the necessary namespace URIs for
	 * this element is reported through the declareNamespace method or the
	 * getPrefix method.
	 */
	...
	/**
	 * Obtains the namespace URI currently associated to the given prefix. If no
	 * namespace URI is associated, return null.
	 */
	@Override
