...
/**
 * Convenient default implementation of {@link UnmarshallingEventHandler} to
 ...
 * 
 * Once an exception is in the form of UnmarshalException, we consider it to be
 * already reported to the client app.
 */
public abstract class AbstractUnmarshallingEventHandlerImpl implements
	...
	/**
	 * This method is called by the generated derived class when a datatype
	 * parse method throws an exception.
	 */
	protected void handleParseConversionException(Exception e)
			throws SAXException {
		if (e instanceof RuntimeException)
			throw (RuntimeException) e; // don't catch the runtime exception.
										// just let it go.
	...
	private void reportError(String msg, boolean canRecover)
			throws SAXException {
		reportError(msg, null, canRecover);
	}

	private void reportError(String msg, Exception nested, boolean canRecover)
			throws SAXException {
		context.handleEvent(new ValidationEventImpl(
				canRecover ? ValidationEvent.ERROR
						: ValidationEvent.FATAL_ERROR, msg,
				new ValidationEventLocatorImpl(context.getLocator()), nested),
				canRecover);
	}

	protected final void revertToParentFromEnterAttribute(String uri,
	...
	//
	//
	protected final void revertToParentFromEnterElement(String uri,
			String local, String qname, Attributes atts) throws SAXException {
		context.popContentHandler();
		context.getCurrentHandler().enterElement(uri, local, qname, atts);
	}

	protected final void revertToParentFromLeaveAttribute(String uri,
			String local, String qname) throws SAXException {
		context.popContentHandler();
		context.getCurrentHandler().leaveAttribute(uri, local, qname);
	}

	protected final void revertToParentFromLeaveElement(String uri,
			String local, String qname) throws SAXException {
		context.popContentHandler();
	...
	protected final Object spawnChildFromEnterAttribute(Class clazz,
			int memento, String uri, String local, String qname)
			throws SAXException {
	...
	protected final Object spawnChildFromEnterElement(Class clazz, int memento,
			String uri, String local, String qname, Attributes atts)
			throws SAXException {
		UnmarshallingEventHandler ueh = spawnChild(clazz, memento);
	...
	protected final Object spawnChildFromLeaveAttribute(Class clazz,
			int memento, String uri, String local, String qname)
			throws SAXException {
		UnmarshallingEventHandler ueh = spawnChild(clazz, memento);
	...
	protected final Object spawnChildFromLeaveElement(Class clazz, int memento,
	...
	protected final Object spawnChildFromText(Class clazz, int memento,
	...
	protected final void spawnHandlerFromEnterAttribute(
			UnmarshallingEventHandler unm, int memento, String uri,
			String local, String qname) throws SAXException {
	...
	protected final void spawnHandlerFromText(UnmarshallingEventHandler unm,
			int memento, String text) throws SAXException {

		context.pushContentHandler(unm, memento);
		unm.text(text);
	}

	protected final Element spawnWildcard(int memento, String uri,
			String local, String qname, Attributes atts) throws SAXException {
		UnmarshallingEventHandler ueh = context.getGrammarInfo()
				.createUnmarshaller(uri, local, context);
	...
	protected final void unexpectedEnterAttribute(String uri, String local,
			String qname) throws SAXException {
		reportError(Messages.format(Messages.UNEXPECTED_ENTER_ATTRIBUTE, uri,
				local), false);
	}

	protected final void unexpectedEnterElement(String uri, String local,
	...
	protected final void unexpectedLeaveAttribute(String uri, String local,
			String qname) throws SAXException {
		reportError(Messages.format(Messages.UNEXPECTED_LEAVE_ATTRIBUTE, uri,
				local), false);
	}
	...
	protected final void unexpectedLeaveElement(String uri, String local,
			String qname) throws SAXException {
		reportError(
