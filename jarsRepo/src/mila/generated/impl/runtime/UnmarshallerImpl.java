 ...
 * 
 * <p>
 * This class can be extended by the generated code to provide type-safe
 * unmarshall methods.
 * 
...
public class UnmarshallerImpl extends AbstractUnmarshallerImpl {
	...
	/**
	 * Creates and configures a new unmarshalling pipe line. Depending on the
	 * setting, we put a validator as a filter.
	 * 
	 * @return A component that implements both UnmarshallerHandler and
	 *         ValidationEventHandler. All the parsing errors should be reported
	 *         to this error handler for the unmarshalling process to work
	 *         correctly.
	 * 
	 * @param locator
	 *            The object that is responsible to obtain the source location
	 *            information for {@link ValidationEvent}s.
	 */
	private SAXUnmarshallerHandler createUnmarshallerHandler(Locator locator) {

		SAXUnmarshallerHandler unmarshaller = new SAXUnmarshallerHandlerImpl(
				this, grammarInfo);
		...
		try {
			...
			// impossible since we've already made sure that a grammar is
			// accessible.
			e.printStackTrace();
		}
